...
public:
	...
	virtual double tqz_getLongPosition(const char* stdCode) = 0;
	virtual double tqz_getShortPosition(const char* stdCode) = 0;
	...
	virtual void tqz_writeLog(string logFilename, const string logContent) = 0;

	virtual uint32_t tqz_getTradingDate() = 0;
